...
$query = $con->query("SELECT * FROM petitions WHERE titre LIKE '%$filtre%' OR description LIKE '%$filtre%' ");
if($query === false){
   die('Erreur SQL');}
...
<body style="background:url('http://127.0.0.1/projet_pweb/images-projet/couverture.png');background-size: cover;">
	...
	<a href="consultpet_admin.php"><img src="http://127.0.0.1/projet_pweb/images-projet/retour.png" style="margin-left: 15px; margin-top: 30px;"></a>
